# Health Monitoring Graph Creation
# File: healthmonitoring_ggplot2.r
# History: 7-Aug-2023
#
# Following code creates a line graph with upper and lower limits denoted by 
# line and color regions
...
#Use the following lines to order the dates if in day, month, year format
